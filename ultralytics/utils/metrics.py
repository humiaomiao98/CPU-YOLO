...
def bbox_iou(box1, box2, epoch=1, xywh=False, GIoU=False, DIoU=False, CIoU=True, SIoU=False, EIoU=False, WIoU=False,
    ...
    if UIoU:
        ...
        if xywh:
            ...
            # 对于xyxy格式，计算中心点
            bb1_xc = (b1_x1 + b1_x2) / 2
            bb1_yc = (b1_y1 + b1_y2) / 2
            bb2_xc = (b2_x1 + b2_x2) / 2
            bb2_yc = (b2_y1 + b2_y2) / 2
